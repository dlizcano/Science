...
function [AccumUpVar,Vh,Ql,Rl] = Network_Calibration( ArcID,...
                      ...
                      Vh,Ql, Rl,Trp,Tpr, Q_Umb, V_Umb, b, Y)
%% DATA PRE-PROCESING
...
while NumberBranches == 1
    ...
    if NumberBranches > 1           
        for i = 1:NumberBranches 
            ...
            [cum_vars, Vh,Ql,Rl] = Network_Calibration( ArcID, Arc_InitNode, Arc_EndNode, start_sub_id,...
